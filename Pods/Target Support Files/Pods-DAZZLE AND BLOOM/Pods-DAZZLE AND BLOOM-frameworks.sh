...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/AnimatedCardInput/AnimatedCardInput.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/ModularSidebarView/ModularSidebarView.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/Refreshable/Refreshable.framework"
